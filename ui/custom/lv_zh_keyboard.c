...
const lv_obj_class_t lv_zh_keyboard_class = {.constructor_cb = lv_zh_keyboard_constructor,
...
static const lv_btnmatrix_ctrl_t default_kb_ctrl_lc_map[] = {LV_BTNMATRIX_CTRL_HIDDEN,
                                                             LV_BTNMATRIX_CTRL_HIDDEN,
                                                             LV_ZH_KEYBOARD_CTRL_BTN_FLAGS | 5,
                                                             LV_KB_BTN(4),
                                                             LV_KB_BTN(4),
                                                             LV_KB_BTN(4),
                                                             LV_KB_BTN(4),
                                                             ...
                                                             LV_ZH_KEYBOARD_CTRL_BTN_FLAGS | 6,
                                                             LV_KB_BTN(3),
                                                             LV_KB_BTN(3),
                                                             LV_KB_BTN(3),
                                                             LV_KB_BTN(3),
                                                             ...
                                                             LV_KB_BTN(3),
                                                             LV_BTNMATRIX_CTRL_CHECKED | 7,
                                                             LV_BTNMATRIX_CTRL_CHECKED | LV_KB_BTN(1),
                                                             LV_BTNMATRIX_CTRL_CHECKED | LV_KB_BTN(1),
                                                             LV_KB_BTN(1),
                                                             LV_KB_BTN(1),
                                                             LV_KB_BTN(1),
                                                             ...
                                                             LV_BTNMATRIX_CTRL_CHECKED | LV_KB_BTN(1),
                                                             LV_BTNMATRIX_CTRL_CHECKED | LV_KB_BTN(1),
                                                             LV_ZH_KEYBOARD_CTRL_BTN_FLAGS | 2,
                                                             LV_ZH_KEYBOARD_CTRL_BTN_FLAGS | 3,
...
static const lv_btnmatrix_ctrl_t default_kb_ctrl_uc_map[] = {LV_BTNMATRIX_CTRL_HIDDEN,
                                                             LV_BTNMATRIX_CTRL_HIDDEN,
                                                             LV_ZH_KEYBOARD_CTRL_BTN_FLAGS | 5,
                                                             LV_KB_BTN(4),
                                                             LV_KB_BTN(4),
...
static const lv_btnmatrix_ctrl_t default_kb_ctrl_spec_map[] = {LV_BTNMATRIX_CTRL_HIDDEN,
                                                               LV_BTNMATRIX_CTRL_HIDDEN,
                                                               LV_KB_BTN(1),
                                                               LV_KB_BTN(1),
                                                               LV_KB_BTN(1),
...
static const lv_btnmatrix_ctrl_t default_kb_ctrl_num_map[] = {
    1, 1, 1, LV_ZH_KEYBOARD_CTRL_BTN_FLAGS | 2, 1, 1, 1, LV_ZH_KEYBOARD_CTRL_BTN_FLAGS | 2, 1, 1, 1, 2, 1, 1, 1, 1, 1};

static const char **en_kb_map[9] = {
    (const char **)&default_kb_map_lc[4], (const char **)&default_kb_map_uc[4], (const char **)&default_kb_map_spec[4],
    (const char **)default_kb_map_num,    (const char **)default_kb_map_lc,     (const char **)default_kb_map_lc,
    (const char **)default_kb_map_lc,     (const char **)default_kb_map_lc,     (const char **)NULL,
};

static const lv_btnmatrix_ctrl_t *en_kb_ctrl[9] = {
    &default_kb_ctrl_lc_map[2], &default_kb_ctrl_uc_map[2], &default_kb_ctrl_spec_map[2],
    default_kb_ctrl_num_map,    default_kb_ctrl_lc_map,     default_kb_ctrl_lc_map,
    default_kb_ctrl_lc_map,     default_kb_ctrl_lc_map,     NULL,
};

static const char **zh_kb_map[9] = {
    (const char **)default_kb_map_lc,  (const char **)default_kb_map_uc, (const char **)default_kb_map_spec,
    (const char **)default_kb_map_num, (const char **)default_kb_map_lc, (const char **)default_kb_map_lc,
    (const char **)default_kb_map_lc,  (const char **)default_kb_map_lc, (const char **)NULL,
};

static const lv_btnmatrix_ctrl_t *zh_kb_ctrl[9] = {
    default_kb_ctrl_lc_map,  default_kb_ctrl_uc_map, default_kb_ctrl_spec_map,
    default_kb_ctrl_num_map, default_kb_ctrl_lc_map, default_kb_ctrl_lc_map,
    default_kb_ctrl_lc_map,  default_kb_ctrl_lc_map, NULL,
};
...
static void set_selection_box(uint8_t cand_show)
{
    if (zh_input_obj->obj_selection_box != NULL)
    {
        ...
        else if (cand_show == 1)
        {
            ...
            lv_obj_set_height(zh_input_obj->adjustable_box, 50);
            lv_obj_set_height(zh_input_obj->obj_selection_box, 50);
...
static void init_selection_box(lv_obj_t *parent)
{
    ...
    lv_obj_align(zh_input_obj->pinyin_label, LV_ALIGN_LEFT_MID, 5, 0);
    lv_obj_clear_flag(zh_input_obj->pinyin_label, LV_OBJ_FLAG_CLICKABLE);
    lv_obj_set_size(zh_input_obj->pinyin_label, 100, 40);
    lv_obj_add_style(zh_input_obj->pinyin_label, &font_style_24, 0);
    ...
    lv_obj_align(ext_btn, LV_ALIGN_RIGHT_MID, -5, 0);
    lv_obj_set_size(ext_btn, 40, 40);
    ...
    width = lv_obj_get_width(zh_input_obj->obj_selection_box) - 100 - 40 - 20;
    lv_obj_remove_style_all(zh_input_obj->adjustable_box);
    lv_obj_set_width(zh_input_obj->adjustable_box, width);
    lv_obj_add_style(zh_input_obj->adjustable_box, &font_style_24, 0);
    lv_obj_set_style_text_color(zh_input_obj->adjustable_box, lv_color_hex(0x262626), 0);
    lv_obj_align(zh_input_obj->adjustable_box, LV_ALIGN_LEFT_MID, 110, 0);
