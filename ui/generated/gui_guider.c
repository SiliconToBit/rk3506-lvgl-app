...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->cpu_screen_del = true;
    ui->sensor_screen_del = true;
    ui->img_screen_del = true;
    ui->music_screen_del = true;
    ui->video_screen_del = true;
...
{
    ui->g_kb_top_layer = lv_zh_keyboard_create(lv_layer_top(), &lv_font_puhui_18);
    lv_obj_add_event_cb(ui->g_kb_top_layer, kb_event_cb, LV_EVENT_ALL, NULL);
    lv_obj_add_flag(ui->g_kb_top_layer, LV_OBJ_FLAG_HIDDEN);
    lv_obj_set_style_text_font(ui->g_kb_top_layer, &lv_font_puhui_18, LV_PART_MAIN|LV_STATE_DEFAULT);
}
