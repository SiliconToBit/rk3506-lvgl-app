...
static void main_screen_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        case LV_DIR_LEFT:
        {
            ...
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_1, guider_ui.screen_1_del, &guider_ui.main_screen_del, setup_scr_screen_1, LV_SCR_LOAD_ANIM_MOVE_LEFT, 300, 0, false, true);
            break;
        }
        default:
            break;
...
static void screen_1_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_get_act());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_2, guider_ui.screen_2_del, &guider_ui.screen_1_del, setup_scr_screen_2, LV_SCR_LOAD_ANIM_MOVE_LEFT, 300, 0, false, true);
            break;
        }
        case LV_DIR_RIGHT:
        {
            lv_indev_wait_release(lv_indev_get_act());
            ui_load_scr_animation(&guider_ui, &guider_ui.main_screen, guider_ui.main_screen_del, &guider_ui.screen_1_del, setup_scr_main_screen, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 300, 0, false, true);
            break;
        }
        default:
            break;
...
static void screen_1_weather_btn_event_handler (lv_event_t *e)
{
    ...
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.weather_screen, guider_ui.weather_screen_del, &guider_ui.screen_1_del, setup_scr_weather_screen, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 300, 0, false, true);
        break;
    }
    default:
        break;
...
static void screen_1_cpu_btn_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.cpu_screen, guider_ui.cpu_screen_del, &guider_ui.screen_1_del, setup_scr_cpu_screen, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 300, 0, false, true);
        break;
    }
    default:
        break;
...
static void screen_1_setting_btn_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.setting_screen, guider_ui.setting_screen_del, &guider_ui.screen_1_del, setup_scr_setting_screen, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 300, 0, false, true);
        break;
    }
    default:
        break;
...
static void screen_1_sensor_btn_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.sensor_screen, guider_ui.sensor_screen_del, &guider_ui.screen_1_del, setup_scr_sensor_screen, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 300, 0, false, true);
        break;
    }
    default:
        break;
...
static void screen_1_img_btn_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.img_screen, guider_ui.img_screen_del, &guider_ui.screen_1_del, setup_scr_img_screen, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 300, 0, false, true);
        break;
    }
    default:
        break;
...
static void screen_1_music_btn_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.music_screen, guider_ui.music_screen_del, &guider_ui.screen_1_del, setup_scr_music_screen, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 300, 0, false, true);
        break;
    }
    default:
        break;
...
static void screen_2_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_get_act());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_1, guider_ui.screen_1_del, &guider_ui.screen_2_del, setup_scr_screen_1, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 300, 0, false, true);
            break;
        }
        default:
            break;
...
static void screen_2_video_btn_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.video_screen, guider_ui.video_screen_del, &guider_ui.screen_2_del, setup_scr_video_screen, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 300, 0, false, true);
        break;
    }
    default:
        break;
...
static void screen_2_camera_btn_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.camera_screen, guider_ui.camera_screen_del, &guider_ui.screen_2_del, setup_scr_camera_screen, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 300, 0, false, true);
        break;
    }
    default:
        break;
...
static void setting_screen_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_get_act());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_1, guider_ui.screen_1_del, &guider_ui.setting_screen_del, setup_scr_screen_1, LV_SCR_LOAD_ANIM_MOVE_TOP, 300, 0, false, true);
            break;
        }
        default:
            break;
...
static void weather_screen_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_get_act());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_1, guider_ui.screen_1_del, &guider_ui.weather_screen_del, setup_scr_screen_1, LV_SCR_LOAD_ANIM_MOVE_TOP, 300, 0, false, true);
            break;
        }
        default:
            break;
...
static void cpu_screen_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_get_act());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_1, guider_ui.screen_1_del, &guider_ui.cpu_screen_del, setup_scr_screen_1, LV_SCR_LOAD_ANIM_MOVE_TOP, 300, 0, false, true);
            break;
        }
        default:
            break;
...
static void sensor_screen_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_get_act());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_1, guider_ui.screen_1_del, &guider_ui.sensor_screen_del, setup_scr_screen_1, LV_SCR_LOAD_ANIM_MOVE_TOP, 300, 0, false, true);
            break;
        }
        default:
            break;
...
static void img_screen_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_get_act());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_1, guider_ui.screen_1_del, &guider_ui.img_screen_del, setup_scr_screen_1, LV_SCR_LOAD_ANIM_MOVE_TOP, 300, 0, false, true);
            break;
        }
        default:
            break;
...
static void music_screen_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_get_act());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_1, guider_ui.screen_1_del, &guider_ui.music_screen_del, setup_scr_screen_1, LV_SCR_LOAD_ANIM_MOVE_TOP, 300, 0, false, true);
            break;
        }
        default:
            break;
...
void events_init_music_screen (lv_ui *ui)
{
    ...
    lv_obj_add_event_cb(ui->music_screen_music_list_imgbtn, music_screen_music_list_imgbtn_event_handler, LV_EVENT_ALL, ui);
    lv_obj_add_event_cb(ui->music_screen_sound_slider, music_screen_sound_slider_event_handler, LV_EVENT_ALL, ui);
    lv_obj_add_event_cb(ui->music_screen_progress_bar_slider, music_screen_progress_bar_slider_event_handler, LV_EVENT_ALL, ui);
}
...
static void video_screen_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_get_act());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_2, guider_ui.screen_2_del, &guider_ui.video_screen_del, setup_scr_screen_2, LV_SCR_LOAD_ANIM_MOVE_TOP, 300, 0, false, true);
            break;
        }
        default:
            break;
...
static void camera_screen_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_get_act());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_2, guider_ui.screen_2_del, &guider_ui.camera_screen_del, setup_scr_screen_2, LV_SCR_LOAD_ANIM_MOVE_TOP, 300, 0, false, true);
            break;
        }
        default:
            break;
...
static void camera_screen_img_1_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.img_screen, guider_ui.img_screen_del, &guider_ui.camera_screen_del, setup_scr_img_screen, LV_SCR_LOAD_ANIM_FADE_ON, 400, 0, false, true);
        break;
    }
    default:
        break;
