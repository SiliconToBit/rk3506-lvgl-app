...
void setup_scr_main_screen(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->main_screen, 854, 480);
    ...
    lv_img_set_src(ui->main_screen_img_1, &_bizhi_alpha_854x480);
    lv_img_set_pivot(ui->main_screen_img_1, 50,50);
    lv_img_set_angle(ui->main_screen_img_1, 0);
    lv_obj_set_pos(ui->main_screen_img_1, 0, 0);
    lv_obj_set_size(ui->main_screen_img_1, 854, 480);
    ...
    lv_label_set_text(ui->main_screen_label_1, "11:50");
    lv_label_set_long_mode(ui->main_screen_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->main_screen_label_1, 0, 80);
    lv_obj_set_size(ui->main_screen_label_1, 854, 73);
    ...
    lv_obj_set_style_text_color(ui->main_screen_label_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->main_screen_label_1, &lv_font_puhui_64, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->main_screen_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->main_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
